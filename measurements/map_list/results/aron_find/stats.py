...
filenames = ["" + suf + "_result.csv" for suf in ["dict_find_fetch", "dict_find_find", "list_find_get_value", "list_find_keyfind", "list_find_recursive", "map_find_find", "map_find_find_pattern_match"]]
# print(filenames)
# exit(0)
# ^((?!500000;sysfs;energy-pkg).)*\n
methods = ["sysfs", "time"]
