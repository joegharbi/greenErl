-module(fibonacci).
-export([generate_input/1, ordparmap/1, parmap/1,ordparmap_hof/1, parmap_hof/1, parmap_comp/1, ordparmap_comp/1]).

generate_input(Length) -> [generate_list(Length)].

generate_list(0) -> [];
generate_list(Length) -> [40| generate_list(Length-1)].
